...
func (e *testEvaluator) InitLedger(balances transactions.Balances, appIdx basics.AppIndex, schemas basics.StateSchemas) error {
	e.appIdx = appIdx
	return nil
}

func TestAppCallApplyApplicationCallDelta(t *testing.T) {
	a := require.New(t)
...
func TestAppCallApplyApplicationCallGlobalStateDeltas(t *testing.T) {
	a := require.New(t)
	...
	// check empty input
	err := applyEvalDelta(&ac, ed, params, creator, sender, &b, appIdx, errIfNotApplied)
	a.NoError(err)
	a.Equal(0, b.put)
	a.Equal(0, b.putWith)
...
func TestAppCallApplyApplicationCallLocalsStateDeltas(t *testing.T) {
	a := require.New(t)
...
// TestAppCallApplyApplicationCallCreate carefully tracks and validates balance record updates
func TestAppCallApplyApplicationCallCreate(t *testing.T) {
	a := require.New(t)
	...
	err := ApplicationCall(&ac, h, &b, spec, nil, txnCounter, &steva)
	a.Error(err)
	a.Contains(err.Error(), "cannot use empty transactions.ApplyData")
	a.Equal(0, b.put)
	a.Equal(0, b.putWith)
	...
	err = ApplicationCall(&ac, h, &b, spec, ad, txnCounter, &steva)
	a.Error(err)
...
// TestAppCallApplyApplicationCallCreateOptIn checks balance record fields without tracking substages
func TestAppCallApplyApplicationCallCreateOptIn(t *testing.T) {
	a := require.New(t)
...
func TestAppCallApplyApplicationCallCloseOut(t *testing.T) {
	a := require.New(t)
...
func TestAppCallApplyApplicationCallUpdate(t *testing.T) {
	a := require.New(t)
...
func TestAppCallApplyApplicationCallDelete(t *testing.T) {
	a := require.New(t)
...
func TestAppCallApplyApplicationCallCreateClearState(t *testing.T) {
	a := require.New(t)
...
func TestAppCallApplyApplicationCallCreateDelete(t *testing.T) {
	a := require.New(t)
